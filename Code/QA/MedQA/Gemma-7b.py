...
tokenizer = AutoTokenizer.from_pretrained(base_folder + "Gemma-7B-Instruct", padding = "max_length", truncation = True, max_length = 1024)
tokenizer.pad_token = tokenizer.unk_token
tokenizer.pad_token_id =  tokenizer.unk_token_id
tokenizer.padding_side = 'left' # to prevent warnings

training_arguments = TrainingArguments(
    output_dir = "./Results/MedQA/Gemma-7B-Instruct",
    num_train_epochs = 5,
...
model_id = 'Results\MedQA\Gemma-7B-Instruct\checkpoint-3185'
