...
base_folder = "/media/lurker18/Local Disk/HuggingFace/models/MistralAI"
...
tokenizer = AutoTokenizer.from_pretrained(base_folder + "/Mistral-7B-Instruct-v0.2", padding = "max_length" , truncation = "max_length")
