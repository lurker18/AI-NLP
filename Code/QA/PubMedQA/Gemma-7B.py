...
# 4. Select the Google's gemma-7b-Instruct model
...
tokenizer = AutoTokenizer.from_pretrained(base_folder + "gemma-7b-Instruct", padding = "max_length", truncation = True, max_length = 2048)
tokenizer.pad_token = tokenizer.unk_token
tokenizer.pad_token_id =  tokenizer.unk_token_id
tokenizer.padding_side = 'left' # to prevent warnings

training_arguments = TrainingArguments(
    output_dir = "./Results/PubMedQA/Gemma-7B-Instruct",
    num_train_epochs = 5,
